...
Compared with EVLoc, LEAR further improves event-to-LiDAR localization by learning edge-aware representations and introducing cross-task feature fusion. Code: [LEAR](https://github.com/EasonChen99/LEAR)
